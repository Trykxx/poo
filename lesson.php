...
//final c'est une classe non heritable
    //methode finale c'est une methode non modifiable par les enfants
//absract c'est une classe qui ne peut pas etre instancié.
    // methode abstract est une methode obligatoire pour les enfants et n'a pas de corps pour le parent
// une interface est une liste de contrats
    //une classe qui implemente une interface est obligé de remplir tous les contracts
